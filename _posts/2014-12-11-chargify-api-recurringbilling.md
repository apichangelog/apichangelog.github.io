...
**Chargify**: We have not major changes planned at this point in time. As outlined, we are very much an incremental change development house, focusing on small and ongoing change, rather than major releases. Being in the recurring billing space we try to avoid major change in general while maintaining backward compatibility.
